...
REPLACE INTO `navicella` (`nome_navicella`, `cod_navicella`, `username_utente`, `prezzo`) VALUES
	('SS Vulture', '12469785', NULL, 12300000),
	('Ripper', '12576354', NULL, 9930000),
	('P-8 Albatross', '16479855', NULL, 1300000),
	('Huntress', '19528943', NULL, 1200000),
	('STS Alice', '19785957', NULL, 2300000),
	('USS Exploration', '23456877', NULL, 8930000),
	('BS Invincible', '25489673', NULL, 7830000),
	('SC Fighter', '31245875', NULL, 6960000),
	('Violet Panama', '32556256', NULL, 3830000),
	('Stellar Flare', '34798512', NULL, 4570000),
	('The Kobayashi', '35489568', NULL, 84300000),
	('CS Carnage V', '45231845', NULL, 56000700),
	('BS Vespira', '46798524', NULL, 49000000),
	('LWSS The Jellyfish', '51873642', NULL, 20000000),
	('Divine Intervention', '54687129', NULL, 40000000),
	('Duke Elba', '56232658', NULL, 70000000),
	('Pursuer', '56723841', NULL, 999999),
	('Elizabeth', '63457528', NULL, 54300000),
	('Akimbo Maze', '64758238', NULL, 2430400),
	('Fuchsia Midway', '65485128', NULL, 56470000),
	('HWSS Spectrum', '65496512', NULL, 19700000),
	('Galactic Core', '65783918', NULL, 32800000),
	('BC Zion', '66245879', NULL, 3726000),
	('Hummingbird', '71395256', NULL, 34272900),
	('SC Cataphract', '74569167', NULL, 8363500),
	('STS Deinonychus', '75395146', NULL, 26243900),
	('Dark Phoenix', '76458311', NULL, 32835000),
	('Lime Victory', '78545985', NULL, 8264800),
	('K-26 Matador', '78987653', NULL, 26284500),
	('STS Analyzer', '81346795', NULL, 5532900),
	('BS Empress', '85214653', NULL, 73538400),
	('Ravana Mark IV', '85445689', NULL, 72544380),
	('Battlecruiser Elena', '85631599', NULL, 7543200),
	('HMS Atlas', '86455732', NULL, 85320000),
	('Halcyon Invincible 3', '86475365', NULL, 6243000),
	('D2 Stalwart II', '87129621', NULL, 8424000),
	('Harmony', '96458731', NULL, 93547000),
	('Banger Kryptoria', '96476535', NULL, 64332200),
	('STS Athens IV', '96522542', NULL, 76452300),
	('BS Independence', '98563265', NULL, 34606900);
